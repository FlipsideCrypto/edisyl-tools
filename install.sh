...
# Configuration
REPO="FlipsideCrypto/edisyl-tools"
BINARY_NAME="edisyl"
...
main() {
    ...
    if [ -n "$EDISYL_VERSION" ]; then
        VERSION="$EDISYL_VERSION"
    ...
    echo ""
    echo "Get started:"
    echo "  ${BINARY_NAME} login          # Authenticate with your Flipside account"
    echo "  ${BINARY_NAME} fleet list     # List your organization's fleets"
